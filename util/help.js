...
module.exports = function cutString (s) {
    if (!s) return s
...
// Number => wei string
module.exports = function ntyToWei(coin) {
...
function weiToNTY(wei) {
    return decShift(wei, -18);
}

function weiToMNTY(wei) {
    return decShift(wei, -24);
}

function weiToNUSD(wei) {
...
// string
module.exports = function weiToEthS (weiAmount) {
...
module.exports = async function callTxCode(web3, tx) {
...
module.exports = async function sendTxCode(web3, tx) {
...
module.exports = function hhmmss(_secs) {
    var secs = _secs
...
module.exports = function charFormatNoSpace (s) {
    return cutString(s.replace(/[^a-zA-Z0-9,.?!]/ig, ''))
}

module.exports = function mmss(endTime) {
...
// unit = second
module.exports = function getTimeDiff(endTime) {
    var now = moment().unix()
